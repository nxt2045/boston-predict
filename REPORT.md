...
![](img/8e76786e084317e234eee51d16dd3ad9.png){:width="25%"}
...
![](img/af404935a3508d8274dc74331038cb35.png)
...
![](img/a6483d6ae27223ef391e0adadf7d2aaf.png)
...
![](img/d16c24e5a0e766d169a44ebcca12c526.png)
...
![](img/bb3d4d95920758c47c2c27016df68cf6.png)
...
![](img/278d6bb92d79cba3516d2a7aed827bd9.png)
...
![](img/d04ac7351dd83fe4498bb1eb64fb1efe.png)
...
![](img/e83ec7eb04f2fc338828a5a2db945cb7.png)
...
![](img/3d213c93b0f36a90bfbdc7c1639ff736.png)
...
![](img/40b12cf445ef5c7a52a60d96f05c4ef4.png)
...
![](img/850b20a3c6028fca44c64b630823ba4c.png)
...
![](img/c10bcfdacca5e92ba607a210476611d1.png)
...
![](img/74721798cf1749f0eb4618c4232e5f41.png)
...
![](img/217ab1397b8b672500fedc8396735baa.png)

分箱形成的新字段，先Onehot编码再与原表格连接。

![](img/15177892375e97ba126f19a856ae0fb5.png)
...
![](img/71b6b5c91cfd3edf585e5b637838b79b.png)

![](img/ce37ec0aaecb074330839741dcef7a25.png)
...
![](img/aad42eda47053aadab99587da7887627.png)

### 3.2 训练模型

用train_test_split划分训练集和测试集

![](img/80d808f6e708e1b88f527c1d5ba1a423.png)

sklearn.model_selection库中有GridSearchCV方法，搜索模型的最优参数。

![](img/a65cb9ca7583015704da410426c2a9e2.png)

示例过程如下：

![](img/ff30437344090eefa586c13d1fc70c9a.png)

利用得到的参数，训练模型

![](img/d0b31b5fce612d523d3addca098460cf.png)

## 四、实验结果分析

用train_test_split划分得到的测试集，多次实验结果如下，可以看出本模型准确率(R\^2)稳定在0.92以上，

![](img/bf82e394fc8d723b8c70a3237d0b2326.png)

将预测与真实值画图比较可以看出，本模型准确率高，泛化能力强，并且有能力预测房价为50的异常值

![图片包含 天空 描述已自动生成](img/f291b3e5eacfec1ffa8a6e0790ad2d53.png)
